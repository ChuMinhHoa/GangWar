...
namespace UIAnimation {
    ...
    public static class UIAnimationController {
        ...
        public static Sequence BtnAnimType1(Transform trsDoAnim, float duration, UnityAction actioncallBack = null) {
        ...
        public static Sequence BtnAnimZoomBasic(Transform trsDoAnim, float duration, UnityAction actioncallBack = null) {
            Sequence mainSquence = DOTween.Sequence();
        ...
        public static Sequence PanelPopUpBasic(Transform trsDoAnim, float duration, UnityAction actioncallBack = null)
        {
        ...
        public static Sequence PanelPopUpBasic(Transform trsDoAnim, float duration, bool loop, UnityAction actioncallBack = null) {
        ...
        public static Sequence PopupBigZoomLoop(Transform trsDoAnim, float duration, UnityAction actioncallBack = null)
        {
            Sequence mainSquence = DOTween.Sequence();
            mainSquence.Append(trsDoAnim.DOScale(vectorScaleTo12, duration / 2));
            mainSquence.Append(trsDoAnim.DOScale(vectorDefault, duration / 2));
        ...
        public static Sequence CanvasGroup(CanvasGroup cGroup, float duration, float target, UnityAction actionCallBack = null) {
            Sequence mainSquence = DOTween.Sequence();
            mainSquence.Append(cGroup.DOFade(target, duration));
            mainSquence.Play();
            mainSquence.OnComplete(() =>
            {
                if (actionCallBack != null)
